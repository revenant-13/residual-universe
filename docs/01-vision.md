...
Fit, undock, fight, mine, haul, invent, lose the hull. High-sec is practice, not a wage. Low-sec and null pay because you can die. Compact outposts are later-phase orbital infrastructure: recycle, rebuild, contest the well.

The Residual’s space fantasy is **presence under risk**. Dying is expensive. Reshipping is meaningful.

### Ground (ASIWars)

You do not command humans. You place Zones, craft Protocols, load Models, set standing orders, and keep the colony coherent enough that nudges land. Contested mining sites and raids are watchable, destructive, Clash-of-Clans-with-influence events. You hope for outcomes. Training and Models tilt the odds.

The Residual’s ground fantasy is **stewardship without a body**. Destruction is spectacle. The scarce permanent stakes are Vessels — and especially the **Models** (weights) they carry.

### Why they belong together

Ground extraction produces **unique / high-value inputs** space industry cannot print from belts. Space risk and orbital infrastructure decide whether a colony is a safe teaching toy or a contested prize. Stations/outposts industrialize and protect the loot; they are not required to *start* playing with humans.
...
- ML jargon as diegetic language: *weights, priors, inference, residual, fine-tune, checkpoint, drift, guardrails.*
...
- Dock & Focus: *“Attention parked. Hull is in a licensed berth. Colony telemetry is yours.”*
